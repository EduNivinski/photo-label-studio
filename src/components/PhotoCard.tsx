...
export function PhotoCard({ 
  ...
  return (
    <div className="media-card group overflow-hidden transition-all duration-200 hover:shadow-lg cursor-pointer w-[200px] h-[250px] relative border border-photo-border hover:border-primary rounded-lg">
      {/* Selection Checkbox */}
